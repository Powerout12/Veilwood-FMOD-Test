Shader "Skybox/CubemapSkyboxBlend" {
	Properties {
		// can adjust the color of the cubemaps here or in inspector
	    _Tint ("Tint Color", Color) = (.5, .5, .5, 1)
	    _Tint2 ("Tint Color 2", Color) = (.5, .5, .5, 1)
		[NoScaleOffset] _Tex ("Day", Cube) = "grey" {}
	    [NoScaleOffset] _Tex2 ("Night", Cube) = "grey" {}
	...
	SubShader {
		// allows for it to be Skybox shader not just any shader
